...
//go:generate minimock -i github.com/s0vunia/platform_common/pkg/db.DB -o db_minimock.go -n DBMock -p mocks
...
import (
	...
	mm_db "github.com/s0vunia/platform_common/pkg/db"
)
...
func (m *DBMock) MinimockBeginTxInspect() {
	...
	if !m.BeginTxMock.invocationsDone() && afterBeginTxCounter > 0 {
		m.t.Errorf("Expected %d calls to DBMock.BeginTx but found %d calls",
...
func (m *DBMock) MinimockCloseInspect() {
	...
	if !m.CloseMock.invocationsDone() && afterCloseCounter > 0 {
		m.t.Errorf("Expected %d calls to DBMock.Close but found %d calls",
...
func (mmExecContext *mDBMockExecContext) ExpectQParam2(q mm_db.Query) *mDBMockExecContext {
	if mmExecContext.mock.funcExecContext != nil {
		mmExecContext.mock.t.Fatalf("DBMock.ExecContext mock is already set by Set")
	}
...
func (m *DBMock) MinimockExecContextInspect() {
	...
	if !m.ExecContextMock.invocationsDone() && afterExecContextCounter > 0 {
		m.t.Errorf("Expected %d calls to DBMock.ExecContext but found %d calls",
...
func (mmPing *DBMock) Ping(ctx context.Context) (err error) {
	...
	if mmPing.PingMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmPing.t.Errorf("DBMock.Ping got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}
...
func (m *DBMock) MinimockPingInspect() {
	...
	if !m.PingMock.invocationsDone() && afterPingCounter > 0 {
		m.t.Errorf("Expected %d calls to DBMock.Ping but found %d calls",
...
func (mmQueryContext *mDBMockQueryContext) ExpectQParam2(q mm_db.Query) *mDBMockQueryContext {
	if mmQueryContext.mock.funcQueryContext != nil {
		mmQueryContext.mock.t.Fatalf("DBMock.QueryContext mock is already set by Set")
	}
...
func (mmQueryContext *DBMock) QueryContext(ctx context.Context, q mm_db.Query, args ...interface{}) (r1 pgx.Rows, err error) {
	...
	if mmQueryContext.QueryContextMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmQueryContext.t.Errorf("DBMock.QueryContext got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.q != nil && !minimock.Equal(*mm_want_ptrs.q, mm_got.q) {
				mmQueryContext.t.Errorf("DBMock.QueryContext got unexpected parameter q, want: %#v, got: %#v%s\n", *mm_want_ptrs.q, mm_got.q, minimock.Diff(*mm_want_ptrs.q, mm_got.q))
			}

			if mm_want_ptrs.args != nil && !minimock.Equal(*mm_want_ptrs.args, mm_got.args) {
				mmQueryContext.t.Errorf("DBMock.QueryContext got unexpected parameter args, want: %#v, got: %#v%s\n", *mm_want_ptrs.args, mm_got.args, minimock.Diff(*mm_want_ptrs.args, mm_got.args))
			}
...
func (m *DBMock) MinimockQueryContextInspect() {
	...
	if !m.QueryContextMock.invocationsDone() && afterQueryContextCounter > 0 {
		m.t.Errorf("Expected %d calls to DBMock.QueryContext but found %d calls",
			mm_atomic.LoadUint64(&m.QueryContextMock.expectedInvocations), afterQueryContextCounter)
	}
}
...
func (mmQueryRowContext *mDBMockQueryRowContext) ExpectQParam2(q mm_db.Query) *mDBMockQueryRowContext {
	if mmQueryRowContext.mock.funcQueryRowContext != nil {
		mmQueryRowContext.mock.t.Fatalf("DBMock.QueryRowContext mock is already set by Set")
	}
...
func (mmQueryRowContext *DBMock) QueryRowContext(ctx context.Context, q mm_db.Query, args ...interface{}) (r1 pgx.Row) {
	...
	if mmQueryRowContext.QueryRowContextMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmQueryRowContext.t.Errorf("DBMock.QueryRowContext got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.q != nil && !minimock.Equal(*mm_want_ptrs.q, mm_got.q) {
				mmQueryRowContext.t.Errorf("DBMock.QueryRowContext got unexpected parameter q, want: %#v, got: %#v%s\n", *mm_want_ptrs.q, mm_got.q, minimock.Diff(*mm_want_ptrs.q, mm_got.q))
			}

			if mm_want_ptrs.args != nil && !minimock.Equal(*mm_want_ptrs.args, mm_got.args) {
				mmQueryRowContext.t.Errorf("DBMock.QueryRowContext got unexpected parameter args, want: %#v, got: %#v%s\n", *mm_want_ptrs.args, mm_got.args, minimock.Diff(*mm_want_ptrs.args, mm_got.args))
			}
...
func (m *DBMock) MinimockQueryRowContextInspect() {
	...
	if !m.QueryRowContextMock.invocationsDone() && afterQueryRowContextCounter > 0 {
		m.t.Errorf("Expected %d calls to DBMock.QueryRowContext but found %d calls",
			mm_atomic.LoadUint64(&m.QueryRowContextMock.expectedInvocations), afterQueryRowContextCounter)
	}
}
...
// ExpectDestParam2 sets up expected param dest for DB.ScanAllContext
func (mmScanAllContext *mDBMockScanAllContext) ExpectDestParam2(dest interface{}) *mDBMockScanAllContext {
	if mmScanAllContext.mock.funcScanAllContext != nil {
		mmScanAllContext.mock.t.Fatalf("DBMock.ScanAllContext mock is already set by Set")
	}
	...
	mmScanAllContext.defaultExpectation.paramPtrs.dest = &dest

	return mmScanAllContext
}

// ExpectQParam3 sets up expected param q for DB.ScanAllContext
func (mmScanAllContext *mDBMockScanAllContext) ExpectQParam3(q mm_db.Query) *mDBMockScanAllContext {
	if mmScanAllContext.mock.funcScanAllContext != nil {
		mmScanAllContext.mock.t.Fatalf("DBMock.ScanAllContext mock is already set by Set")
	}
...
func (mmScanAllContext *DBMock) ScanAllContext(ctx context.Context, dest interface{}, q mm_db.Query, args ...interface{}) (err error) {
	...
	if mmScanAllContext.ScanAllContextMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmScanAllContext.t.Errorf("DBMock.ScanAllContext got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.dest != nil && !minimock.Equal(*mm_want_ptrs.dest, mm_got.dest) {
				mmScanAllContext.t.Errorf("DBMock.ScanAllContext got unexpected parameter dest, want: %#v, got: %#v%s\n", *mm_want_ptrs.dest, mm_got.dest, minimock.Diff(*mm_want_ptrs.dest, mm_got.dest))
			}

			if mm_want_ptrs.q != nil && !minimock.Equal(*mm_want_ptrs.q, mm_got.q) {
				mmScanAllContext.t.Errorf("DBMock.ScanAllContext got unexpected parameter q, want: %#v, got: %#v%s\n", *mm_want_ptrs.q, mm_got.q, minimock.Diff(*mm_want_ptrs.q, mm_got.q))
			}

			if mm_want_ptrs.args != nil && !minimock.Equal(*mm_want_ptrs.args, mm_got.args) {
				mmScanAllContext.t.Errorf("DBMock.ScanAllContext got unexpected parameter args, want: %#v, got: %#v%s\n", *mm_want_ptrs.args, mm_got.args, minimock.Diff(*mm_want_ptrs.args, mm_got.args))
			}
...
func (m *DBMock) MinimockScanAllContextInspect() {
	...
	if !m.ScanAllContextMock.invocationsDone() && afterScanAllContextCounter > 0 {
		m.t.Errorf("Expected %d calls to DBMock.ScanAllContext but found %d calls",
			mm_atomic.LoadUint64(&m.ScanAllContextMock.expectedInvocations), afterScanAllContextCounter)
	}
}
...
// ExpectDestParam2 sets up expected param dest for DB.ScanOneContext
func (mmScanOneContext *mDBMockScanOneContext) ExpectDestParam2(dest interface{}) *mDBMockScanOneContext {
	if mmScanOneContext.mock.funcScanOneContext != nil {
		mmScanOneContext.mock.t.Fatalf("DBMock.ScanOneContext mock is already set by Set")
	}
	...
	mmScanOneContext.defaultExpectation.paramPtrs.dest = &dest

	return mmScanOneContext
}

// ExpectQParam3 sets up expected param q for DB.ScanOneContext
func (mmScanOneContext *mDBMockScanOneContext) ExpectQParam3(q mm_db.Query) *mDBMockScanOneContext {
	if mmScanOneContext.mock.funcScanOneContext != nil {
		mmScanOneContext.mock.t.Fatalf("DBMock.ScanOneContext mock is already set by Set")
	}
...
func (mmScanOneContext *DBMock) ScanOneContext(ctx context.Context, dest interface{}, q mm_db.Query, args ...interface{}) (err error) {
	...
	if mmScanOneContext.ScanOneContextMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmScanOneContext.t.Errorf("DBMock.ScanOneContext got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.dest != nil && !minimock.Equal(*mm_want_ptrs.dest, mm_got.dest) {
				mmScanOneContext.t.Errorf("DBMock.ScanOneContext got unexpected parameter dest, want: %#v, got: %#v%s\n", *mm_want_ptrs.dest, mm_got.dest, minimock.Diff(*mm_want_ptrs.dest, mm_got.dest))
			}

			if mm_want_ptrs.q != nil && !minimock.Equal(*mm_want_ptrs.q, mm_got.q) {
				mmScanOneContext.t.Errorf("DBMock.ScanOneContext got unexpected parameter q, want: %#v, got: %#v%s\n", *mm_want_ptrs.q, mm_got.q, minimock.Diff(*mm_want_ptrs.q, mm_got.q))
			}

			if mm_want_ptrs.args != nil && !minimock.Equal(*mm_want_ptrs.args, mm_got.args) {
				mmScanOneContext.t.Errorf("DBMock.ScanOneContext got unexpected parameter args, want: %#v, got: %#v%s\n", *mm_want_ptrs.args, mm_got.args, minimock.Diff(*mm_want_ptrs.args, mm_got.args))
			}
...
func (m *DBMock) MinimockScanOneContextInspect() {
	...
	if !m.ScanOneContextMock.invocationsDone() && afterScanOneContextCounter > 0 {
		m.t.Errorf("Expected %d calls to DBMock.ScanOneContext but found %d calls",
			mm_atomic.LoadUint64(&m.ScanOneContextMock.expectedInvocations), afterScanOneContextCounter)
	}
}
